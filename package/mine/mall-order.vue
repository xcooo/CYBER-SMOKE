 ...
 * @LastEditTime: 2025-04-27 16:59:07
 * @Description: content
-->
<template>
  <view class="page-wrap">
    <uni-nav-bar title="商城订单" color="#fff" leftIcon="left" backgroundColor="#222333" :border="false" :statusBar="true"
    ...
    <mescroll-body ref="mescrollRef" @init="mescrollInit" @down="downCallback" @up="getList" :down="downOption"
      ...
      <view class="list">
        <view v-for="(item, i) in listData" :key="i" class="list-item">
          ...
          <view class="list-item-bd">订单号:{{ item.order_sn }}</view>
