 ...
 * @LastEditTime: 2022-12-22 11:00:39
 * @Description: content
-->
<template>
    ...
    <template v-if="orderData">
      <view class="goods-card">
        <view class="goods-card-item">
          <view class="goods-card-item-l">
            <view class="dot">原</view>
          </view>

          <view class="goods-card-item-r">
            <view class="pic">
              <cimage :src="orderData.old.thumb" mode="scaleToFill" />
            </view>
            ...
            <view class="info">
              ...
              <view class="price-num">
                <view class="price">
                  ...
                  <text>
                    <text>{{ orderData.old.price }}</text>
                  </text>
                </view>

                <view class="num">×{{ orderData.old.num }}</view>
              </view>
            </view>
          </view>
        </view>

        <view class="goods-card-exchange">转换后</view>

        <view class="goods-card-item">
          <view class="goods-card-item-l">
            <view class="dot red">新</view>
          </view>

          <view class="goods-card-item-r">
            <view class="pic">
              <cimage :src="orderData.new.thumb" mode="scaleToFill" />
            </view>
            ...
            <view class="info">
              ...
              <view class="price-num">
                <view class="price">
                  ...
                  <text>
                    <text>{{ orderData.new.price }}</text>
                  </text>
                </view>

                <view class="num">×{{ orderData.new.num }}</view>
              </view>
            </view>
          </view>
        </view>
      ...
      <view class="info-card">
        ...
        <view class="row">
          ...
          <view class="right">
            <view v-if="orderData.express.express_money * 1 > 0" class="red">
        ...
        <view
          v-if="orderData.express.express_money * 1 > 0"
          @click="getRule"
          class="rule-btn"
        >
          共{{ orderData.new.num }}个包裹,需支付{{
            orderData.express.express_money
          }}元邮费
